...
const Home = ({doctors}) =>(
    <div className="home-container">
        <div className='header'>
            ...
            <input type='search' className='search-doctor' placeholder='Search for doctors'/>
            </div>
        </div>
        <div className="main-container-doctors-list">
            <ul className="doctor-list-container">
            {
                doctors.map((each) => <Doctors doctorsList = {each} key = {each.id}/>)
            }
        </ul>
        </div>
    </div>
